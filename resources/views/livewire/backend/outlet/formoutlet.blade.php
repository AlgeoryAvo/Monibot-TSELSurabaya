                        ...
                        <div class="card-body">
                            <div class="page-header">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h3 class="page-title">Form Outlet</h3>
                                    </div>
                                </div>
                            </div>
                                ...
                                <form wire:submit.prevent='store' method="post">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>Lokasi</td>
                                            <td>
                                                <input type="text" required class="form-control" wire:model='location'
                                        ...
                                        <tr>
                                            <td>Pemilik</td>
                                            <td>
                                                <input type="text" required class="form-control" wire:model='owner'
                                        ...
                                        <tr>
                                            <td></td>
                                            <td>
                                                <a href="{{ route('outlet') }}" class="btn btn-warning"><i
